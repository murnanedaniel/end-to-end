...
#     print(args)
    ...
    train_dataset = [prepare_event(event_file, args.pt_cut, [1000, np.pi, 1000], args.adjacent) for event_file in all_events[:4000]]
    ...
    model = EmbeddingToAGNNPretrained(**m_configs, pretrained_model=embedding_model).to(device)
