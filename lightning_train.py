...
def parse_args():
    ...
    add_arg(
        "-r", "--regime", nargs="+", help="Choose regime of [rp, hnm, ci]", default=None
    )
    ...
    add_arg("--randomisation", type=float, default=None, help="Ratio of RP to truth")
    add_arg(
        "--warmup", type=float, default=None, help="Number of BATCHES to warmup upon"
    )
